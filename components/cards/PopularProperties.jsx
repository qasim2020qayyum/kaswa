        ...
        <div className="container">
          <div className="grid grid-cols-12">
            <div className="col-span-12">
              {" "}
              <span className="text-secondary text-tiny inline-block mb-2 hero__title">
                Best Choice
              </span>
            </div>
            <div className="col-span-12">
              <div className="flex flex-col sm:flex-row items-start justify-between mb-[50px]">
                ...
                <div>
                  <a
                    ...
                    className="hero__title flex flex-wrap items-center text-secondary text-tiny"
                  >
                    Explore all
                    <svg
                      className="ml-[10px]"
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-[30px]">
            <div className="overflow-hidden rounded-md drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px]">
              <div className="relative">
                ...
                <span className="absolute bottom-5 left-5 bg-[#FFFDFC] p-[5px] rounded-[2px] text-secondary leading-none text-[14px] font-normal capitalize hero__title">
                  for Sale
                </span>
              </div>
              <div className="py-[20px] px-[20px]">
                <h3>
                  ...
                  >
                    <span className="card__title">Lake City</span>
                  </a>
                </h3>
                <h4>
                  <a
                    href="properties-details.html"
                    className="font-light text-tiny text-secondary underline hero__title"
                  >
                    Lake City - Sector M-7C, Lake City, Raiwind Road, Lahore,
                    Punjab
                  </a>
                </h4>
                ...
                <div className="before:block before:absolute before:top-1/2 before:-translate-y-1/2 before:h-[1px] before:w-full before:z-[-1] before:bg-[#E0E0E0] relative">
                  <span className="font-recoleta text-base text-primary px-[15px] bg-white">
                    <span className="card__price">PKR 2.98 cr</span>
                  </span>
                </div>
                <p className="font-light">
                  10 marla - 4 Bed - 3 Bath - 1 Garage
                </p>
              </div>
            </div>
            <div className="overflow-hidden rounded-md drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px]">
              <div className="relative">
                ...
                <span className=" hero__title absolute bottom-5 left-5 bg-[#FFFDFC] p-[5px] rounded-[2px] text-secondary leading-none text-[14px] font-normal capitalize">
                  for Rent
                </span>
              </div>
              <div className="py-[20px] px-[20px]">
                <h3>
                  <a
                    ...
                    className="font-recoleta leading-tight text-[22px] xl:text-lg text-primary"
                  >
                    <span className="card__title">Green Villas</span>
                  </a>
                </h3>
                <h4>
                  <a
                    href="properties-details.html"
                    className=" hero__title font-light text-tiny text-secondary underline"
                  >
                    Green Villas, Adiala Road, Rawalpindi, Punjab
                  </a>
                </h4>
                <span className="font-light text-sm">
                  Added: 25 November, 2021
                ...
                <div className="before:block before:absolute before:top-1/2 before:-translate-y-1/2 before:h-[1px] before:w-full before:z-[-1] before:bg-[#E0E0E0] relative">
                  <span className="font-recoleta text-base text-primary px-[15px] bg-white">
                    <span className="card__price">PKR 4.5 cr</span>
                  </span>
                </div>
                <p className="font-light">
                  1 kanal - 5 Bed - 3 Bath - 2 Garage
                </p>
              </div>
            </div>
            <div className="overflow-hidden rounded-md drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px]">
              ...
              <div className="py-[20px] px-[20px]">
                <h3>
                  <a
                    ...
                    className="font-recoleta leading-tight text-[22px] xl:text-lg text-primary"
                  >
                    <span className="card__title">Khayaban e Ameen</span>
                  </a>
                </h3>
                <h4>
                  <a
                    ...
                    className="hero__title font-light text-tiny text-secondary underline"
                  >
                    Khayaban-e-Amin - Block M, Khayaban-e-Amin, Lahore, Punjab
                  </a>
                </h4>
                <span className="font-light text-sm">
                  Added: 25 November, 2021
                ...
                <div className="before:block before:absolute before:top-1/2 before:-translate-y-1/2 before:h-[1px] before:w-full before:z-[-1] before:bg-[#E0E0E0] relative">
                  <span className="font-recoleta text-base text-primary px-[15px] bg-white">
                    <span className="card__price">PKR 1.75 cr</span>
                  </span>
                </div>
                <p className="font-light">
                  5 Marla - 3 Bed - 2 Bath - 1 Garage
                </p>
              </div>
            </div>
          </div>
