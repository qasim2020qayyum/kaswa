        ...
        <form action="#">
          <div className="grid grid-cols-12 gap-x-[30px]">
            <div className="mb-[45px] col-span-12 md:col-span-8">
              <label
                className="mb-[20px] font-recoleta text-[18px] leading-none block text-primary"
            ...
            <div className="mb-[45px] col-span-12 md:col-span-4">
              ...
              <div className="relative">
                ...
                >
                  ...
                  <option value={1}>PKR 5000</option>
                  <option value={2}>PKR 7000</option>
                </select>
              </div>
            </div>
          ...
          <div className="grid grid-cols-12 gap-x-[30px]">
            <div className="mb-[45px] col-span-12">
              <label className="mb-[20px] font-recoleta text-[18px] leading-none block text-primary">
                Add Images
              </label>
