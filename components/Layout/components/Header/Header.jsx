          ...
          <nav className="offcanvas-menu">
            <ul>
              <li className="relative block border-b-primary border-b first:border-t first:border-t-primary">
                <Link href="/">
                  <a className="block capitalize font-normal text-black hover:text-secondary text-base my-2 py-1 px-5 closeNav">
                    Home
                  </a>
                </Link>
              </li>
              ...
              <li className="relative block border-b-primary border-b">
                <Link href="services">
                  <a className="relative block capitalize font-normal text-black hover:text-secondary text-base my-2 py-1 px-5 closeNav">
                    Services
                  </a>
                </Link>
              </li>
              ...
              <li className="relative block border-b-primary border-b">
                <Link href="contact">
                  <a className="relative block capitalize text-black hover:text-secondary text-base my-2 py-1 px-5  closeNav">
                    Contact
                  </a>
                </Link>
              </li>
            ...
            <li className="relative block border-b-primary border-b">
              ...
              <ul className="offcanvas-submenu static top-auto hidden w-full visible opacity-100 capitalize">
                <li>
                  <Link href="login">
                    <a className="text-sm py-2 px-[30px] text-black font-light block transition-all hover:text-secondary  closeNav">
                      Login
                    </a>
                  </Link>
                </li>
